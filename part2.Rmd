...
- Create a subset of the European data where the life expectancy is greater than 80 in the 2000s
...
- Using the filter function, find all countries that start with the letter Z
  + Hint: first create a new column in `gapminder` which is the first letter of each country (you can do this the using `substr` function)
...
See the online notes for a suggestion:-

![](https://raw.githubusercontent.com/sheffield-bioinformatics-core/r-crash-course/master/images/facet_exercise.png)
