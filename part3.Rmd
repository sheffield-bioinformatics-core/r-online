...
```
```{r}
filter(covid, country == "United Kingdom") %>% 
  count(`Province/State`)
```
...
- Which European countries have the highest number of cases per 100,000 population
  + e.g. [https://www.statista.com/statistics/1110187/coronavirus-incidence-europe-by-country/](https://www.statista.com/statistics/1110187/coronavirus-incidence-europe-by-country/)
